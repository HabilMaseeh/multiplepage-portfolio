      ...
      <div className="relative z-20 w-full mx-auto lg:mx-0">
        ...
        <div className="flex flex-col md:flex-row gap-8 mt-3 sm:mt-4 lg:mt-6">
          <div className="w-full md:w-1/2 flex flex-col">
            ...
            <div className="mt-6">
              <h3 className="text-lg font-semibold text-neutral-900 dark:text-neutral-100">What I build</h3>
              <ul className="mt-3 space-y-2 text-sm leading-6 text-neutral-600 dark:text-neutral-400">
                {aboutConfig.services.map((service, index) => (
                  <li key={index} className="flex gap-2">
                    <span className="text-neutral-900 dark:text-neutral-100" aria-hidden="true">+</span>
                    <span>{service}</span>
                  </li>
                ))}
              </ul>
          ...
          <div className="w-full md:w-1/2 flex justify-end">
            <div className="relative w-[360px] h-[360px]">
              <Image
                ...
                alt="Habil Maseeh profile picture"
                fill
        ...
        <div className="w-[360px] ml-8">
          ...
          <div className="py-[30px]">
            ...
            <div className="flex flex-wrap gap-4 mt-5 text-sm font-medium">
              {Object.values(aboutConfig.connect.links).map((link) => (
                <a key={link.text} href={link.url} target="_blank" rel="noopener noreferrer" className="text-indigo-600 dark:text-indigo-400 underline hover:no-underline">
                  {link.text}
                </a>
              ))}
            </div>
